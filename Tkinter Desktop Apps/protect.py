...
def clear(event=None):
  En1.delete("0",END)
  error1.place(x=1200,y=1200) # حطانا الابعاد كبيرة جدا حتى لاتظهر
def one(event=None) :
  En1.insert(END,"1") 
...
def enter(evebt=None):
  ...
  if password != "2022":
    global error1 #استخدمنا هذة الدالة مناجل استدعائها فى دالة أخرى
    error1=Label(fr1,text="error in password!",fg="red",bg="white")
